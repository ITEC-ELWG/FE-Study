...
=======
//表达式状态
>>>>>>> 7ee377e895212995b142c62cc6383fec957178c1
var flag1;//输入第一个数字
...
function myfunction(num_id){	
	//输入数字
	if(num_id==0 || num_id==1 || num_id==2 || num_id==3 || num_id==4 || num_id==5 || num_id==6 || num_id==7 || num_id==8 || num_id==9)
	{
